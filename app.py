...
def main():  
    ...
    if uploaded_file is not None:
        ...
        with open(os.path.join("VideoSample/",uploaded_file.name.split("/")[-1]),"wb") as f:
        ...
        if st.button('Classify The Video'):
            ...
            with st.spinner('Wait for it...'):
                ...
                predict_on_live_video("VideoSample/"+uploaded_file.name.split("/")[-1], output_video_file_path, SEQUENCE_LENGTH)
            ...
            video_file = open("video/"+"output4.mp4", 'rb') #enter the filename with filepath
